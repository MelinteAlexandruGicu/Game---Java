...
/*! \class EndLevel extends StaticEntity
    \brief Defineste notiunea abstracta de steag.
 */
public class EndLevel extends StaticEntity {

    public int id = 2; /*!< Referinta catre id.*/
...
*/
    public EndLevel(Handler handler, float x, float y) {
    ...
    */
    @Override
    public void draw(Graphics g) {
        g.drawImage(Assets.endLevel, (int) (x - handler.getGameCamera().getxOffset()), (int) (y - handler.getGameCamera().getyOffset()), width, height, null);
